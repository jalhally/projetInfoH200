...
public class Fenetre extends JFrame implements KeyListener {
	...
	public Fenetre() {
		...
		l = new Link(0,200,200,0,3,"res/linkRunRight.png",0,0,0,false,false); //penser ‡ utiliser vitesse
	...
	private void wololo() {
		...
		if(tireFleche){
			...
			if(l.getDirection() == 4){
				...
				//System.out.println("je tire ‡ gauche");
				if(i == 1){
					link.z = -4;
				}
				else if(i == 3){
			...
			if(l.getDirection() == 3){
				...
				//System.out.println("je tire ‡ droite");
				if(i == 1){
					link.z = -4;
				}
				else if(i == 3){
		...
		if(j == 1){
			link.x3 += 5;
			System.out.println("kirby bouge ‡ droite, sa position est : " + link.x3);
			if (link.x3 > 1500){
				j = 0;
				link.image3 = vide;
			}
